...
export class SettingsService {
  ...
  private toDto(settings: any): SettingsDTO {
    return {
      ...
      salesTax: Number(settings.salesTax),
      defaultDiscountLabel: settings.defaultDiscountLabel,
      maxAutoDiscountPercent: Number(settings.maxAutoDiscountPercent),
      refundAlertThreshold: Number(settings.refundAlertThreshold),
